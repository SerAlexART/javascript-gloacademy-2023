...
function cleanHandsOperation3() {
    ...
    step(1, 'Испачкать руки.'); //  в это примере два аргумента
...
// * Нечистая функциия
// Опасность в том, что переменная может находится далеко от самой функции и её могут поменять, что может повлиять на работоспособность дфункции
let pureCount2 = 55;
...
// Callback функция обратного вызова. Внутрь функции в виде аргументов можно передать числа, строки, объейты, массивы и даже функции. Можем принять функцию в параметр и запустить этот параметр
